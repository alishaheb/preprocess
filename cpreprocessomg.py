...
class DataPreprocessor:
    ...
    def fit_transform(self, data: pd.DataFrame) -> pd.DataFrame:
        ...
        Steps:
            1. Impute missing numeric values using the specified numeric strategy.
            2. Impute missing non-numeric values using the 'most_frequent' strategy.
            3. Apply outlier treatment (IQR method) and scaling to numeric data.
        ...
        if len(numeric_cols) > 0:
            ...
            # Scaling numeric data if scaler is provided
            ...
            print("No numeric columns detected for imputation and scaling.")
...
if __name__ == "__main__":
    ...
    if df is not None:
        ...
        output_file = "third_C_processed_Hp.csv"
